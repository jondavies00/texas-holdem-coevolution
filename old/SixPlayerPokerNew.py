...
class Game():
    ...
    def __init__(self, test, small_blind, max_hands, starting_chips=20000):
        ...
        if test == 'random':
            ...
            p1, p2, p3, p4, p5, p6 = TAGPlayer('Player 1'), TAGPlayer('Player 2'), TAGPlayer('Player 3'), TAGPlayer('Player 4'), TAGPlayer('Player 5'), NeuralPlayer('Player 6')
            self.pprint = False
        else:
            self.pprint = False
...
class TAGPlayer(Player):
    ...
    def getActionType(self, preflop, to_act_after, acted, out, community_cards, potsize, cbet):
        ...
        # and continue with good holdings. They may sometimes bluff.
        ...
        flopContinue = randint(0, 3)  
        riverContinue = randint(1, 4)
        ...
        if preflop == 0:
            ...
            #flop
            if Game.get_highest_combo(([self.hand.first,self.hand.second] + community_cards)) >= flopContinue:
                betorRaise = True
            elif uniform(0, 1) < bluffChance:
                betorRaise= True
            else:
            ...
            #river
            if Game.get_highest_combo(([self.hand.first,self.hand.second] + community_cards)) >= riverContinue:
                betorRaise = True
            elif uniform(0, 1) < bluffChance:
                betorRaise= True
            else:
            ...
            if Game.get_highest_combo(([self.hand.first,self.hand.second] + community_cards)) >= turnContinue:
                betorRaise = True
            elif uniform(0, 1) < bluffChance:
                betorRaise= True
            else:
