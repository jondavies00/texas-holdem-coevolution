...
### Performs six-population pareto coevolution
...
def eaSimple(population, toolbox, cxpb, mutpb, ngen, stats=None,
    ...
    for gen in range(1, ngen + 1):
        ...
        pickle.dump(population, open("Gathering Results/saves/Six-Population Pareto Coevolution NGSA/Attempt 2 (USING)/population%i_gen%i.p" % (i, gen), 'wb') )
